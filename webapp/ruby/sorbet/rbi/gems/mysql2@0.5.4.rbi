...
class Mysql2::Client
  ...
  # source://mysql2-cs-bind/0.1.1/lib/mysql2-cs-bind.rb#7
  ...
  class << self
    ...
    # source://mysql2-cs-bind/0.1.1/lib/mysql2-cs-bind.rb#15
    def pseudo_bind(sql, values); end

    # source://mysql2-cs-bind/0.1.1/lib/mysql2-cs-bind.rb#43
