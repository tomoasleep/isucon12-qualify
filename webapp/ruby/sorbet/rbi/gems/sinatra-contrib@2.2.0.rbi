...
module Sinatra
  class << self
    # source://sinatra/2.2.0/lib/sinatra/base.rb#2013
    def helpers(*extensions, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#2001
    def new(base = T.unsafe(nil), &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#2008
    def register(*extensions, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#2018
...
class Sinatra::Application < ::Sinatra::Base
  ...
  class << self
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1286
    def app_file; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1285
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1294
    def ext_map=(val); end

    def ext_map?; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1938
    def logging; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1943
    def register(*extensions, &block); end

    # source://sinatra-contrib//lib/sinatra/reloader.rb#233
    ...
    # source://sinatra-contrib//lib/sinatra/reloader.rb#232
    def reloader; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/main.rb#35
    def run; end
...
class Sinatra::Base
  ...
  # source://sinatra/2.2.0/lib/sinatra/base.rb#928
  def initialize(app = T.unsafe(nil), **kwargs); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#925
  def app; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#925
  def app=(_arg0); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#937
  def call(env); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#941
  def call!(env); end
  ...
  # source://sinatra/2.2.0/lib/sinatra/base.rb#994
  def forward; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#981
  def halt(*response); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#973
  def options; end
  ...
  # source://sinatra/2.2.0/lib/sinatra/base.rb#989
  def pass(&block); end
  ...
  # source://sinatra/2.2.0/lib/sinatra/base.rb#969
  def settings; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#926
  def template_cache; end

  private

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1127
  def dispatch!; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1208
  def dump_errors!(boom); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1193
  def error_block!(key, *block_params); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1007
  def filter!(type, base = T.unsafe(nil), &block); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1799
  def force_encoding(*args); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1153
  def handle_exception!(boom); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1111
  def invoke; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1050
  def process_route(pattern, conditions, block = T.unsafe(nil), values = T.unsafe(nil)); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1016
  def route!(base = T.unsafe(nil), pass_block = T.unsafe(nil)); end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1041
  def route_eval; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1086
  def route_missing; end

  # source://sinatra/2.2.0/lib/sinatra/base.rb#1096
  ...
  class << self
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1408
    def add_filter(type, path = T.unsafe(nil), **options, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1403
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1396
    def before(path = T.unsafe(nil), **options, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1839
    def bind; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1543
    def build(app); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1551
    def call(env); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1557
    def caller_files; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1563
    def caller_locations; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1414
    def condition(name = T.unsafe(nil), &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1474
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1443
    def delete(path, opts = T.unsafe(nil), &bk); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1468
    def development?; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1312
    def disable(*opts); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1805
    def dump_errors; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1307
    def enable(*opts); end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1319
    def error(*codes, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1231
    def errors; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1252
    def extensions; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1231
    def filters; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1787
    def force_encoding(data, encoding = T.unsafe(nil)); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1433
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1444
    def head(path, opts = T.unsafe(nil), &bk); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1452
    def helpers(*extensions, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1345
    ...
    # source://sinatra-contrib//lib/sinatra/json.rb#123
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1339
    def layout(name = T.unsafe(nil), &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1447
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1261
    def middleware; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1377
    def mime_type(type, value = T.unsafe(nil)); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1388
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1536
    def new(*args, **kwargs, &bk); end

    def new!(*_arg0); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1328
    def not_found(&block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1445
    def options(path, opts = T.unsafe(nil), &bk); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1446
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1442
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1469
    def production?; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1526
    def prototype; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1418
    def public=(value); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1427
    def public_dir; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1423
    def public_dir=(value); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1867
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1441
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1486
    def quit!; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1804
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1459
    def register(*extensions, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1863
    def reload_templates; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1235
    def reset!; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1861
    def root; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1500
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1521
    def running?; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1271
    def set(option, value = T.unsafe(nil), ignore_setter = T.unsafe(nil), &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#964
    def settings; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1806
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1868
    def static; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1333
    def template(name, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1231
    def templates; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1470
    def test?; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1448
    def unlink(path, opts = T.unsafe(nil), &bk); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1479
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1862
    def views; end
    ...
    # source://sinatra/2.2.0/lib/sinatra/base.rb#1623
    def agent(pattern); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1778
    def cleaned_caller(keep = T.unsafe(nil)); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1690
    def compile(path, route_mustermann_opts = T.unsafe(nil)); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1671
    def compile!(verb, path, block, **options); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1609
    def define_singleton(name, content = T.unsafe(nil)); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1664
    def generate_method(method_name, &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1617
    def host_name(pattern); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1757
    def inherited(subclass); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1660
    def invoke_hook(name, *args); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1636
    def provides(*types); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1652
    def route(verb, path, options = T.unsafe(nil), &block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1721
    def setup_common_logger(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1725
    def setup_custom_logger(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1694
    def setup_default_middleware(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1708
    def setup_logging(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1704
    def setup_middleware(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1717
    def setup_null_logger(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1733
    def setup_protection(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1749
    def setup_sessions(builder); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1593
    def setup_traps; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1570
    def start_server(handler, server_settings, handler_name); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1589
    def suppress_messages?; end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1764
    def synchronize(&block); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1623
    def user_agent(pattern); end

    # source://sinatra/2.2.0/lib/sinatra/base.rb#1773
...
module Sinatra::ConfigFile
  ...
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#146
  ...
  # @return [Boolean]
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#166
  def environment_keys?(hash); end

  # Given a +hash+ returns the settings corresponding to the current
  # environment.
  #
  # source://sinatra-contrib//lib/sinatra/config_file.rb#160
...
class Sinatra::ConfigFile::UnsupportedConfigType < ::Exception
  # source://sinatra-contrib//lib/sinatra/config_file.rb#136
  def message; end
end
