...
# source://jwt//lib/jwt/default_options.rb#4
module JWT::DefaultOptions; end

# source://jwt//lib/jwt/default_options.rb#5
...
class JWT::JWK::EC < ::JWT::JWK::KeyBase
  ...
  class << self
    # @raise [JWT::JWKError]
    #
    # source://jwt//lib/jwt/jwk/ec.rb#86
    def import(jwk_data); end

    # source://jwt//lib/jwt/jwk/ec.rb#96
    ...
    # source://jwt//lib/jwt/jwk/ec.rb#148
    def decode_open_ssl_bn(jwk_data); end

    # source://jwt//lib/jwt/jwk/ec.rb#117
    def ec_pkey(jwk_crv, jwk_x, jwk_y, jwk_d); end

    # source://jwt//lib/jwt/jwk/ec.rb#111
...
class JWT::JWK::RSA < ::JWT::JWK::KeyBase
  ...
  # source://jwt//lib/jwt/jwk/rsa.rb#40
  ...
  class << self
    ...
    # source://jwt//lib/jwt/jwk/rsa.rb#72
    def jwk_attributes(jwk_data, *attributes); end

    # source://jwt//lib/jwt/jwk/rsa.rb#87
